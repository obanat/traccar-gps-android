...
public class AndroidPositionProvider extends PositionProvider implements LocationListener {
    ...
    public AndroidPositionProvider(Context context, PositionListener listener) {
        ...
        provider = getProvider(preferences.getString(Position.KEY_ACCURACY,
                context.getString(R.string.settings_gps_accuracy_default_value)));
    }
    ...
    public void startUpdates() {
        try {
            ...
            StatusActivity.addMessage("requestLocationUpdates success");
    ...
    @Override
    public void onLocationChanged(Location location) {
        StatusActivity.addMessage("raw onLocationChanged");
