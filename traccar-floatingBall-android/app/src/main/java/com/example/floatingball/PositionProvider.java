...
public abstract class PositionProvider {
    ...
    public PositionProvider(Context context, PositionListener listener) {
        ...
        deviceId = preferences.getString(Position.KEY_DEVICE,
                context.getString(R.string.settings_devId_default_value));
        interval = Long.parseLong(preferences.getString(Position.KEY_INTERVAL, "5")) * 1000;
        distance = Integer.parseInt(preferences.getString(Position.KEY_DISTANCE, "0"));
        angle = Integer.parseInt(preferences.getString(Position.KEY_ANGLE, "0"));
    }
    ...
    protected void processLocation(Location location) {
        Log.i(TAG, "location-new processLocation");
        if (location != null && (lastLocation == null
            ...
            long inte = -1;
            if (location != null && lastLocation != null) {
                inte = location.getTime() - lastLocation.getTime();

            }
            Log.i(TAG, location != null ? "location interval=" + inte : "location nil");
        }
    }
